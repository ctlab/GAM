...
```{r chache=TRUE, error=FALSE, message=FALSE, fig.width=5, fig.height=5}
...
One can add edges for trans- pairs of metabolites in reactions:
```{r fig.width=12,fig.height=16,error=FALSE,message=FALSE}
module <- addTransEdges(module, es)
plotNetwork(module)
```

After that one can save resulting module into pdf, XGMML
